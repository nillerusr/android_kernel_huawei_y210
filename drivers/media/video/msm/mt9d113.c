...
static long mt9d113_set_wb(int wb)
{
    ...
    if(MODEL_SUNNY == mt9d113_model_id)
    {
        ...
        case CAMERA_WB_AUTO:
            ...
            {
                if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xAB20 ))){return rc;} 	// MCU_ADDRESS [HG_LL_SAT1]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0088 ))){return rc;}	// MCU_DATA_0 0~255,normal use 120,150——————这个寄存器多处用到，请杨海民在每一处都判断V2和V3，是V3就修改成0x0080，具体可以咨询吴晓金
            }
            ...
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0x232E))){return rc;} // MCU_ADDRESS [AWB_CCM_RL_9]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0010))){return rc;} // MCU_DATA_0
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0x2330))){return rc;} // MCU_ADDRESS [AWB_CCM_RL_10]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0xFFF0))){return rc;} // MCU_DATA_0
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA369))){return rc;} // MCU_ADDRESS [AWB_KR_R]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x008B))){return rc;} // MCU_DATA_0
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA36B))){return rc;} // MCU_ADDRESS [AWB_KB_R]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0088))){return rc;} // MCU_DATA_0
        ...
        case CAMERA_WB_INCANDESCENT:
            ...
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0078))){return rc;}// MCU_DATA_0 0x0080
            ...
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0091))){return rc;}// MCU_DATA_0 0x0086
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34A))){return rc;}// MCU_ADDRESS [AWB_GAIN_MIN]
        ...
        case CAMERA_WB_FLUORESCENT:
            ...
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34E))){return rc;}// MCU_ADDRESS [AWB_GAIN_R]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0089))){return rc;}// MCU_DATA_0   0x008D
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34F))){return rc;}// MCU_ADDRESS [AWB_GAIN_G]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0080))){return rc;}// MCU_DATA_0
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA350))){return rc;}// MCU_ADDRESS [AWB_GAIN_B]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x007F))){return rc;}// MCU_DATA_0  0x0083 0x0073
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34A))){return rc;}// MCU_ADDRESS [AWB_GAIN_MIN]
        ...
        case CAMERA_WB_DAYLIGHT:
            ...
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34E))){return rc;}// MCU_ADDRESS [AWB_GAIN_R]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0079))){return rc;}// MCU_DATA_0  0x009D
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34F))){return rc;}// MCU_ADDRESS [AWB_GAIN_G]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0080))){return rc;}// MCU_DATA_0
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA350))){return rc;}// MCU_ADDRESS [AWB_GAIN_B]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0083))){return rc;}// MCU_DATA_0   0x0072
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34A))){return rc;}// MCU_ADDRESS [AWB_GAIN_MIN]
        ...
        case CAMERA_WB_CLOUDY_DAYLIGHT:
            ...
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x007F))){return rc;}// MCU_DATA_0
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34E))){return rc;}// MCU_ADDRESS [AWB_GAIN_R]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x008B))){return rc;}// MCU_DATA_0  0x00B8
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34F))){return rc;}// MCU_ADDRESS [AWB_GAIN_G]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0080))){return rc;}// MCU_DATA_0 //0x0081
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA350))){return rc;}// MCU_ADDRESS [AWB_GAIN_B]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0072))){return rc;}// MCU_DATA_0  0x0060
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34A))){return rc;}// MCU_ADDRESS [AWB_GAIN_MIN]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0080))){return rc;}// MCU_DATA_0  
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34B))){return rc;}// MCU_ADDRESS [AWB_GAIN_MAX]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0080))){return rc;}// MCU_DATA_0
    ...
    else // BYD
    {
        ...
        case CAMERA_WB_AUTO:
            ...
            {
                if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xAB20 ))){return rc;}	// MCU_ADDRESS [HG_LL_SAT1]
                if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x005D ))){return rc;}	// MCU_DATA_0 0~255,normal use 120,150——————这个寄存器多处用到，请杨海民在每一处都判断V2和V3，是V3就修改成0x0080，具体可以咨询吴晓金
            }
        ...
        case CAMERA_WB_INCANDESCENT:
            ...
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0000))){return rc;}// MCU_DATA_0
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34E))){return rc;}// MCU_ADDRESS [AWB_GAIN_R]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0076))){return rc;}// MCU_DATA_0 0x0082
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34F))){return rc;}// MCU_ADDRESS [AWB_GAIN_G]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0080))){return rc;}// MCU_DATA_0
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA350))){return rc;}// MCU_ADDRESS [AWB_GAIN_B]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0090))){return rc;}// MCU_DATA_0    0x0092  0x0090
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34A))){return rc;}// MCU_ADDRESS [AWB_GAIN_MIN]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0072))){return rc;}// MCU_DATA_0
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34B))){return rc;}// MCU_ADDRESS [AWB_GAIN_MAX]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0072))){return rc;}// MCU_DATA_0
        ...
        case CAMERA_WB_FLUORESCENT:
            ...
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0032))){return rc;}// MCU_DATA_0
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34E))){return rc;}// MCU_ADDRESS [AWB_GAIN_R]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0099))){return rc;}// MCU_DATA_0   0x0092  
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34F))){return rc;}// MCU_ADDRESS [AWB_GAIN_G]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0080))){return rc;}// MCU_DATA_0
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA350))){return rc;}// MCU_ADDRESS [AWB_GAIN_B]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x006F))){return rc;}// MCU_DATA_0  0x0073
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34A))){return rc;}// MCU_ADDRESS [AWB_GAIN_MIN]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x008C))){return rc;}// MCU_DATA_0
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34B))){return rc;}// MCU_ADDRESS [AWB_GAIN_MAX]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x008C))){return rc;}// MCU_DATA_0
        ...
        case CAMERA_WB_DAYLIGHT:
            ...
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x007F))){return rc;}// MCU_DATA_0
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34E))){return rc;}// MCU_ADDRESS [AWB_GAIN_R]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0095))){return rc;}// MCU_DATA_0  0x009A
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34F))){return rc;}// MCU_ADDRESS [AWB_GAIN_G]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0080))){return rc;}// MCU_DATA_0
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA350))){return rc;}// MCU_ADDRESS [AWB_GAIN_B]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0069))){return rc;}// MCU_DATA_0   0x0070  0x006E
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34A))){return rc;}// MCU_ADDRESS [AWB_GAIN_MIN]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x007D))){return rc;}// MCU_DATA_0
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34B))){return rc;}// MCU_ADDRESS [AWB_GAIN_MAX]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x007D))){return rc;}// MCU_DATA_0
        ...
        case CAMERA_WB_CLOUDY_DAYLIGHT:
            ...
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x007F))){return rc;}// MCU_DATA_0
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34E))){return rc;}// MCU_ADDRESS [AWB_GAIN_R]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x00B4))){return rc;}// MCU_DATA_0  0x00B6 
             
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34F))){return rc;}// MCU_ADDRESS [AWB_GAIN_G]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0080))){return rc;}// MCU_DATA_0 //0x0081
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA350))){return rc;}// MCU_ADDRESS [AWB_GAIN_B]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x005A))){return rc;}// MCU_DATA_0  0x005d
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34A))){return rc;}// MCU_ADDRESS [AWB_GAIN_MIN]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0080))){return rc;}// MCU_DATA_0  
            if(0 > (rc = mt9d113_i2c_write_w( 0x098C, 0xA34B))){return rc;}// MCU_ADDRESS [AWB_GAIN_MAX]
            if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x0080))){return rc;}// MCU_DATA_0
